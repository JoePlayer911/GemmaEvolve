...
*   **Model**: Switched from `gemma-3-12b-it-Q8_0.gguf` (12.5GB) to `gemma-3-12b-it-Q4_K_M.gguf` (~7.3GB).
...
*   **Scale**: Enabled `parallel_evaluations: 4` in `gemma_config.yaml` to maximize all 4 available cards.
